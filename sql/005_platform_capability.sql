...
(
    ...
    '{"type":"object","properties":{"source_document":{"type":"string","x-attachment":{"allowed_media_types":["application/vnd.openxmlformats-officedocument.wordprocessingml.document"],"max_size_bytes":52428800,"max_count":1}},"user_focus":{"type":["string","null"]}},"additionalProperties":false}',
...
(
    ...
    '{"type":"object","properties":{"source_document":{"type":"string","x-attachment":{"allowed_media_types":["application/vnd.openxmlformats-officedocument.wordprocessingml.document"],"max_size_bytes":52428800,"max_count":1}},"start_block_id":{"type":"string"},"end_block_id":{"type":"string"},"output_name":{"type":["string","null"]}}}',
    '{"type":"object","properties":{"artifact":{"type":"object"},"block_count":{"type":"integer"}}}',
    '["source_document","start_block_id","end_block_id"]',
    'always',
    '["agent:tender:execute"]',
    TRUE,
    300,
...
(
    ...
    '{"type":"object","properties":{"source_document":{"type":"string","x-attachment":{"allowed_media_types":["application/vnd.openxmlformats-officedocument.wordprocessingml.document"],"max_size_bytes":52428800,"max_count":1}},"start_block_id":{"type":"string"},"end_block_id":{"type":"string"},"context_radius":{"type":"integer"}}}',
